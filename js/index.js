    ...
    $('#dowebok').fullpage({
		...
		afterRender: function(){
			...
			$("header").animate({opacity:"1"},500,function(){
				...
				$("#home_info1").fadeIn(400,function(){
					$(this).next().animate({width:"800px"},400,function(){
		...
		afterLoad: function(anchorLink,index){
			...
			if(index==2){
				...
				$(".title_en").animate({width:"130px"},500,function(){
...
// 图片轮播
	...
	$("#exp_timeline a").click(function(){
		$("#exp_list_content").stop(true,false).animate({left:-$(".exp_list").width()*$(this).index()},800,"easeInOutCubic");
		page=$(this).index()+1;
		});
...
// 时光轴
	var x=10;
	var y=20;
	$("#exp_timeline a").mouseover(function(event){
		this.aa=this.title;
		this.title="";
